 ...
 *
 * <p>VERSIÓN CORREGIDA: Búsqueda flexible de fusibles para PICs 18F - Búsqueda exacta - Búsqueda
 * case-insensitive - Búsqueda por coincidencia parcial - Mensajes de error útiles con fusibles
 * disponibles - Compatible con Android API 14+
 *
 * <p>Esta clase es la migración de la clase Python "Chipinfo_Entry" y contiene todos los datos de
 * configuración de un microcontrolador PIC específico.
 */
public class ChipinfoEntry {
    ...
    /** ✅ MÉTODO NUEVO: Búsqueda flexible de fusibles Compatible con Android API 14+ */
    private String findFuseName(
            Map<String, Map<String, List<FuseValue>>> fuseConfigs, String fuseName) {
        // 1. Búsqueda exacta
     ...
     *
     * <p>✅ VERSIÓN FINAL CORREGIDA: Matching tolerante para valores imperfectos
     *
    ...
    public Map<String, String> decodeFuseData(List<Integer> fuseValues) throws FuseError {
        ...
        for (Map.Entry<String, Map<String, List<FuseValue>>> fuseParamEntry :
                fuseParamList.entrySet()) {
    ...
    /**
     * Calcula score de coincidencia entre valores leídos y configuración Retorna número de bits que
     * coinciden
     */
    ...
    public List<Integer> encodeFuseData(Map<String, String> fuseDict) throws FuseError {
        ...
        for (Map.Entry<String, String> entry : fuseDict.entrySet()) {
            ...
            if (actualFuseName == null) {
                ...
                throw new FuseError(
                        "Fusible desconocido: \"" + fuse + "\". " + availableFuses.toString());
            }
            ...
            if (!fuseSettings.containsKey(fuseValue)) {
                ...
                availableValues
                        .append("Valores disponibles para '")
                        .append(actualFuseName)
                        .append("': ");
                int count = 0;
                ...
                throw new FuseError(
                        "Configuración de fusible inválida: \""
                                + actualFuseName
                                + "\" = \""
                                + fuseValue
                                + "\". "
